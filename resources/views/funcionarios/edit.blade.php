    ...
    <div class="col-lg-7">
        <div class="card">
            <div class="card-header py-3 px-4">
                <h6 class="mb-0 fw-semibold"><i class="bi bi-pencil me-2 text-muted"></i>Editando: {{ $funcionario->nome }}</h6>
            </div>
            <div class="card-body p-4">
                ...
                @endif
                <form method="POST" action="{{ route('funcionarios.update', encrypt($funcionario->id)) }}">
                    @csrf @method('PUT')
                    <div class="row g-3">
                        <div class="col-12">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="cpf" class="form-control @error('cpf') is-invalid @enderror"
                                value="{{ old('cpf', $funcionario->cpf) }}" maxlength="14" required>
